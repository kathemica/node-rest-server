...
const weakPassword = async (password = "") => {
  ...
  if (!password.match(strongRegex)) {
    throw new Error('password is weak, must contain at least 1 lowercase alphabetical character, at least 1 uppercase alphabetical character, at least 1 numeric character, at least one special character and eight characters or longer');    
  }
